    ...
    <div className="ps-section--vendor ps-vendor-faqs">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h4>Here are some common questions about selling on Galinukkad</h4>
            </div>
            <div className="ps-section__content">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            <figcaption>How do fees work on Galinukkad</figcaption>
                            <p>
                                Free registration and no monthly rentals
                            </p>
                            <p>
                                Sellers have flexibility to offer revenue share
                            </p>
                            {/* <p>
                                Joining and starting a shop on Galinukkad is free. There are three
                                basic selling fees: a listing fee, a transaction fee, and a payment
                                processing fee. Free Registration and no monthly rentals
                            </p>
                            <p>
                        ...
                        <figure>
                            ...
                            <p>
                                It’s easy to set up a shop on Galinukkad. Create an Galinukkad account
                                ...
                                want to pay your Galinukkad fees).
                            </p>
                        </figure>
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        {/* <figure>
                            ...
                            <p>
                                ...
                                Galinukkad will be deposited into your PayPal account. We encourage
                        ...
                        <figure>
                            <figcaption>What can I sell on Galinukkad?</figcaption>
                            <p>
                                Galinukkad provides a marketplace for crafters, artists and collectors to
