    ...
    <div className="ps-home-promotions">
        <div className="container">
            <div className="ps-section__header">
                <h3>
                    WELCOME TO <span>Galinukkad</span> – CUSTOM FURNITURE
            ...
            <div className="row">
                <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 ">
                    <a className="ps-collection" href="#">
                        <img src="/static/img/promotions/home-8/1.jpg" alt="Galinukkad" />
                    </a>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 ">
                    <a className="ps-collection" href="#">
                        <img src="/static/img/promotions/home-8/2.jpg" alt="Galinukkad" />
                    </a>
                </div>
            </div>
        </div>
