                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="mailto:contact@Galinukkad.com">
                                    contact@Galinukkad.com
                                </a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                ...
                                <a href="#">career@Galinukkad.com</a>
                            </p>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">customercare@Galinukkad.com</a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">vendorsupport@Galinukkad.com</a>
