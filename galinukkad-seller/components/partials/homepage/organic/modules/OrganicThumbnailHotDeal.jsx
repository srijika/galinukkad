        ...
        return (
            <div className="ps-product__thumbnail" data-vertical="true">
                ...
                <Slider
                    ...
                    <div className="item">
                        <img src="/static/img/products/home-9/a-1.jpg" alt="Galinukkad" />
                    </div>
                    <div className="item">
                        <img src="/static/img/products/home-9/a-2.jpg" alt="Galinukkad" />
                    </div>
                    <div className="item">
                        <img src="/static/img/products/home-9/a-3.jpg" alt="Galinukkad" />
                    </div>
                </Slider>
            </div>
        );
