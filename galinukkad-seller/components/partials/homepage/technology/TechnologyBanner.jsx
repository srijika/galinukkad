...
class TechnologyBanner extends Component {
    constructor(props) {
        super(props);
    }
            ...
            <section className="ps-home-banner">
                <Slider {...carouselSettings}>
                    <div
                        ...
                        <img src="/static/img/slider/home-10/1.jpg" alt="Galinukkad" />
                    ...
                    <div
                        ...
                        <img src="/static/img/slider/home-10/2.jpg" alt="Galinukkad" />
                        <div className="ps-banner__content">
                            <h4>Weekend Promotions</h4>
                            <h3>
                                iLuv Aud Mini & <br /> Ultra Slim Pocket-Sized <br /> speaker just
                                <strong> 40% Off</strong>
                            </h3>
                            <a className="ps-btn" href="#">
                                Shop Now
