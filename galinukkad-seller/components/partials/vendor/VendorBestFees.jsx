        ...
        <div className="container">
            ...
            {/* <div className="ps-section__content"> */}
                ...
                {/* <div className="ps-section__highlight">
                    <img src="/static/img/icons/vendor-4.png" alt="Galinukkad" />
                    <figure>
                        <p>
                            ...
                            Funds from PayPal sales on Galinukkad will be deposited into your PayPal
                            account.
                        </p>
                    </figure>
                </div>
