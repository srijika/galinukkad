...
class ProductDealOfDay extends Component {
    ...
    render() {
        ...
        if (isStaticData === false) {
            thumbnail = `${product.images.file}`; //`${baseUrl}${product.thumbnail.url}`;
        } else {
        ...
        //             {/* <Link href={"/shop?product="+ product._id} as={`/shop?product=${product._id}`}> */}
        //                 <a>
        //                     <LazyLoad>
        //                         <img src={`${baseUrl}/${getImageName(thumbnail)}`} alt="Galinukkad" />
        //                     </LazyLoad>
        //                 </a>
        //             </Link>
