     ...
     const productImages = [];
        ...
        product.variants.map((variant,index) => {
            if(variant.id == this.state.currentId) {
                variant.thumbnail.forEach((item) => {
                    productImages.push(item.image);
                });
            }
        });
        return (
                                    ...
                                    if (variant.id == this.state.currentId) {
                                        return (
                                            ...
                                            <Slider
                                                ...
                                                {variant.thumbnail.map((item,index) => (
                                                    <div
                                                        className="item"
                                                        key={item.id}>
                                                        <a href="javascript:void(0)"  onClick={e => this.handleOpenLightbox(e, index)}>
                                                            <img
                                                                src={item.image}
                                                                alt="Galinukkad"
                                                            />
                                    ...
                                    <Slider
                                        ...
                                        {variant.thumbnail.map(item => (
                                            <div className="item" key={item.id}>
                                                <img src={item.image} alt="Galinukkad" />
                                            </div>
                                        ))}
                                    </Slider>
                                );
                                ...
                                {product.variants.map(variant => {
                                    return (
                                        <div
                                            ...
                                            <img src={variant.image} alt="Galinukkad" />
                                        </div>
                                    );
                                })}
                            </figure>
