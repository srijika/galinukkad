        ...
        <React.Fragment>
            ...
            <div className="a-fixed-left-grid-inner" style={{paddingLeft: '100px'}}>
                <div className="a-text-center a-fixed-left-grid-col a-col-left" style={{width: '100px', marginLeft: '-100px', float: 'left'}}>
                    <div className="item-view-left-col-inner">
                        <a className="a-link-normal" href="#">
                            <img alt="" src={`${baseUrl}/`+ product.thumbnailImage} height={90} width={90} />
                        </a>
                    </div>
                </div>
                <div className="a-fixed-left-grid-col a-col-right" style={{paddingLeft: '1.5%', float: 'left'}}>
                    ...
                    <div className="a-row">
                        <span onClick={() => Router.push("/product/"+product._id)} className="a-button a-spacing-mini a-button-primary a-button-icon reorder-modal-trigger-button app-heighlighted-btn" id="a-autoid-10">
    ...
    <div className="a-box-group a-spacing-base order">
        <div className="a-box a-color-offset-background order-info"><div className="a-box-inner">
            <div className="a-fixed-right-grid"><div className="a-fixed-right-grid-inner" style={{paddingRight: '290px'}}>
                      ...
                      <div className="a-row a-size-base">
                        <span className="a-color-secondary value">
                          <span style={{textDecoration: 'inherit', whiteSpace: 'nowrap'}}>
                            <span className="currencyINR">&nbsp;&nbsp;</span>
                            <span className="currencyINRFallback">
                            Rs. </span>{order.totalAmount}</span>
                        </span>
                      </div>
                    </div> */}
                ...
                <div className="a-fixed-right-grid-col actions a-col-right" style={{width: '290px', marginRight: '-290px', float: 'left'}}>
                  <div className="a-row a-size-mini">
                    <span className="a-color-secondary label">
                      Order ID : 
                    </span>
              ...
              <div className="a-fixed-right-grid-inner a-grid-vertical-align a-grid-top app-order-list">
    {
       this.props.order && Array.isArray(this.props.order.product) && this.props.order.product.length > 0  ?
        this.props.order.product.map((product, index) => {
          ...
          console.log('product dujhkjdfgh');
          console.log(product);
                 ...
                 return (
                      ...
                      {/* {
                        product.product.reviews.length > 0 ? 
                          <div className="col-md-3 col-sm-12">
                              <span>Your Rating & Reviews</span><br/>
                              <span>
                                  <Rate value={product.product.reviews[0].rating} />
                              </span><br/>
                              <span>{product.product.reviews[0].message}</span> 
                            </div>
                            : <div className="col-md-3 col-sm-12">
                            </div>
                  ...
                  <div className="a-button-stack">
                    <span   onClick={() => Router.push('/account/orders/track/' + this.props.order._id  + 'track' + product.product._id )} className="a-button a-button-normal a-spacing-mini a-button-base app-heighlighted-btn" id="a-autoid-12"><span><a id="Write-a-product-review_2" 
                    
                    className="a-button-text" role="button">Track Package</a></span>
                    </span>
                    {this.props.order.orderStatus !== "Delivered" && this.props.order.orderStatus !== "Returned" && this.props.order.orderStatus !== "Refund" &&  this.props.order.orderStatus !== "Cancelled" ?      <span   onClick={() => this.openModal(this.props.order._id)} className="a-button a-button-normal a-spacing-mini a-button-base app-heighlighted-btn-cancel bg-white" id="a-autoid-12"><span><a id="Write-a-product-review_2" 
                    
                    className="a-button-text" role="button">Cancel Items</a></span>
                    </span>
                    :
                    ''
                  }
        ...
        : "Loading...."
          ...
          <Radio value="Need to Change Payment Method">Need to Change Payment Method</Radio> <br />
              <Radio value="others">
                Others
                {this.state.CancelMessage === "others" ?  <TextArea size="large" placeholder="Comments" onChange={(e)=>this.GetNoteForCancelInput(e)} /> : ''}  
          </Radio>
