                ...
                <Slider {...carouselSettings}>
                    <div className="item">
                        <div
                            ...
                            <img src="/static/img/slider/autopart/1.jpg" alt="Galinukkad" />
                            <div className="ps-banner__content">
                                ...
                                <p>
                                    <strong>Faster, Friction better & Cheap Price</strong>
                                </p>
                    ...
                    <div className="item">
                        <div
                            className="ps-banner--autopart"
                            style={{ backgroundImage: `url(/static/img/bg/blog-detail.jpg)` }}>
                            <img src="/static/img/slider/autopart/2.jpg" alt="Galinukkad" />
                            <div className="ps-banner__content">
                                <h4>Version 2018</h4>
                                <h3>
