		...
		return (
			<Layout>
				...
				<div style={{ height: '50px', backgroundColor: 'white', }}>
					<marquee  class="ann-marquee header_mar" behavior="scroll" direction="left" scrollamount="8" loop="infinite">
						<span className="text_glowing" style={{ position: "relative", top: "15px" }}>  {this.state.announcement}  </span>
					</marquee>
				</div>
				</div>
				: ""}
