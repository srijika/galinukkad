...
//           ['title']: detail.title,
//           ['description']: detail.description == "undefined" ? '' : detail.description,
...
//       //   >
//       <Modal visible={isModalVisible} title={this.props.detail ? 'Update Banner' : 'Add Banner'} onCancel={() => this.handleCancelPress()} footer={<Fragment>
//         <Button onCancel={() => this.handleCancelPress()} >Cancel</Button>
//         <Button type="primary"  className="btn-w25 btn-primary-light" onClick={() => this.handleOkpress()}>{this.props.detail ? 'Update Banner' : 'Add Banner'}</Button>
//       </Fragment>} >

//         <Form {...layout} ref={(formRef) => this.formRef = formRef} name="nest-messages"
//           onFinish={onFinish} validateMessages={validateMessages}>
//           <Form.Item name={'title'} label="Title" rules={[{ required: true },{ max: 50, message: 'Title must not be greater than 50 characters.' }]}>
//             <Input />
//           </Form.Item>
//           <Form.Item name={'description'} label="URL"  rules={[{ required: false },{ max: 50, message: 'URL must not be greater than 50 characters.' }]}>
//             <Input.TextArea />
//           </Form.Item>
...
//             </Select>
//           </Form.Item>
//           <Form.Item {...tailLayout} name="isActive" valuePropName="checked" rules={[{ required: false }]}>
...
export class AddEdit extends React.Component {
  ...
  handleChange = info => {
    if (info.file.type === 'image/jpeg' || info.file.type === 'image/png') {
      ...
      this.setState({errorImg : 'Image is required'})
    }
  ...
  render = () => {
    ...
    const onFinish = values => {
      ...
      if(this.state.file === null && !this.props.detail) {
