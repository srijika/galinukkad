...
class PagesList extends React.Component {
	...
	render() {
		...
		const columns = [
			...
			{ title: <strong>Short Code</strong>, dataIndex: 'description', },
			...
			},
			{
				...
				render: (val, data) => <div onClick={e => e.stopPropagation()}>
					<Button type="primary" className="ant-btn-sm mr-2" onClick={()=>{this.props.history.push('/pages/edit/' + data.slug )}}><EyeOutlined /></Button>
