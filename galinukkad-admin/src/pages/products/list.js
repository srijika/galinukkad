...
class ProductList extends React.Component {
	...
	render() {
		...
		const columns = [
			...
			{
				title: <strong className="primary-text cursor"
				//  onClick={this.ChangeOrder}
				 >Products Name <i className={' fal fa-sm ' + (this.state.sortBy === 'asc' ? "fa-long-arrow-up" : "fa-long-arrow-down")} ></i></strong>,
				dataIndex: 'title',
				width:250,
			...
			{ title: <strong>Action</strong>, width: 130, render: (val, data) => 
						<div>
