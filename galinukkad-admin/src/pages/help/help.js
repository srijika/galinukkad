...
class Help extends React.Component {
  ...
  componentDidMount() {
		setTimeout(() => document.title = 'Seller Help', 100,);
            ...
            <div>
              ...
              <Button onClick={() => { 
                ...
                this.props.history.push(`/seller/${data.loginid}/${data._id}/queries`) }}
                  style={{ marginBottom: '5px', textAlign: 'center', width: '80px', marginRight: '5px' }} type="default">Query</Button>


                <Button onClick={() => { this.props.history.push('/help/detail/' + data._id) }}
                  style={{ marginBottom: '5px', textAlign: 'center', width: '80px', marginRight: '5px' }} type="primary">Details</Button>
                {
                  roleType == 'ADMIN' ?
                    <div>
                        {/* <Button style={{ marginBottom: '5px', textAlign: 'center', width: '80px', marginRight: '0px' }} onClick={() => this.openModal('add_response', data)} type="primary">Add Response</Button><br/> */}
                        {console.log("button" , data)}
                        {data.status === 1 ? 
                        <Button style={{ marginBottom: '5px', textAlign: 'center', width: '80px', marginRight: '0px' }} onClick={() => this.closeTicket(data)} type="danger">Close</Button>
