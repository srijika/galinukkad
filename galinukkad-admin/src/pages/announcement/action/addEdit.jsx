...
import {Modal,  Typography, Form,Input, Button,Select, DatePicker , message } from 'antd';
...
return (
		...
		<Form style={{ padding: "10px" }} {...formItemLayout} form={form} name="loc_info" layout="vertical" onFinish={onFinish} className="innerFields">
			...
			<label> Title </label>
			<Form.Item name="title"  rules={[{ required: true, message: 'This field is required!' },{ max: 50, message: 'Title must not be greater than 50 characters.' }]} >
				<Input type="text" placeholder="Enter Title" />
			</Form.Item>

			<label> Message </label>
			<Form.Item name="message" rules={[{ required: false, message: 'This field is required!' },{ max: 100, message: 'Message must not be greater than 100 characters.' }]} className="mb-0">
